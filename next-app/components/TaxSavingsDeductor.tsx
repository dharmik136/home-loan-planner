    ...
    <div className="panel s6" style={{ marginTop: "16px" }}>
      ...
      <div style={{ marginBottom: "14px", display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
        ...
        <span style={{ fontSize: "0.68rem", color: "var(--ink-faint)", fontStyle: "italic" }}>
          {regime === "old"
            ...
            : "FY 2025-26: No home loan deductions"}
        </span>
      </div>
      ...
      {regime === "new" && (
        <div className="new-regime-notice">
          ...
          <br />
          Sections 24b and 80C are <strong>not available</strong> under the New Tax Regime (FY 2025-26). Your tax bill includes the salaried standard deduction but no home-loan deductions.
          {oldCounterfactual > 0 && (
